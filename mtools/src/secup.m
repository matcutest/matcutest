...
blacklist = [blacklist, {'A0NNDNDL', 'A0NNDNIL', 'A0NNDNSL', 'A0NNSNSL', 'A0NSDSDL', ...
    ...
    'BA-L73LS', 'CYCLIC3LS', 'KSSLS', 'REPEAT', 'LRA9A'}]; % Cause MATLAB to crash: At line 32 of file cdimen.f90 (unit = 42, file = 'OUTSDIF.d') Fortran runtime error: End of file, Segmentation fault
